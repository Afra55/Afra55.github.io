    ...
    groups: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            usedIn: "Markdown 文档管理 · 解析渲染",
            path: "tools/vendor/markdown-it.min.js",
          },
          {
            name: "DOMPurify",
            version: "3.4.15",
            ...
            usedIn: "Markdown 文档管理 · HTML 净化",
            path: "tools/vendor/purify.min.js",
          },
          {
            name: "highlight.js",
            version: "11.12.0",
            ...
            usedIn: "Markdown 文档管理 · 代码高亮",
            path: "tools/vendor/highlight/highlight.min.js",
          },
          {
            name: "CodeMirror 6",
            version: "6.0.2",
            license: "MIT",
            repo: "https://github.com/codemirror/dev",
            usedIn: "Markdown 文档管理 · 编辑器",
            path: "tools/vendor/cm6/cm6.bundle.js",
          },
          {
    name: "KaTeX (+ @vscode/markdown-it-katex)",
    version: "0.18.7 (CSS) / 0.16.47 (内嵌 JS)",
            license: "MIT",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            usedIn: "在线钢琴 · 可选三角钢琴采样",
            path: "cdn.jsdelivr.net/npm/soundfont-player@0.12.0",
          },
          {
            name: "midi-js-soundfonts (MusyngKite)",
            version: "gh-pages",
            license: "MIT",
            repo: "https://github.com/gleitz/midi-js-soundfonts",
            usedIn: "在线钢琴 · 声学采样（按需）",
            path: "cdn.jsdelivr.net/gh/gleitz/midi-js-soundfonts@gh-pages",
          },
          {
            name: "Google Fonts",
            version: "—",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            version: "—",
            license: "MIT",
            repo: "https://github.com/kevinsqi/react-piano",
            usedIn: "在线钢琴 · 键盘布局与快捷键（本地重写，未嵌入 React）",
            path: "—",
          },
        ],
      },
