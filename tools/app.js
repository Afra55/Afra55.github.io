(() => {
  ...
  const TOOL_GROUPS = [
    ...
    { id: "media", label: "媒体", tools: ["gifmaker", "vsplit", "vtrim", "audio", "vplay"] },
    {
      id: "image",
      label: "图片",
      tools: ["imgpreview", "whiteboard", "imgkit", "imgtrim", "textimg", "imgtext", "sharecard", "phlogo", "nokiasms", "imgb64", "qrcode"],
    },
    { id: "convert", label: "换算", tools: ["units", "coord", "numbase"] },
    { id: "fun", label: "趣味", tools: ["wheel", "ruler", "muyu", "minigames", "sandspiel", "ambient"] },
    { id: "health", label: "健康", tools: ["acupoint", "healthread"] },
    { id: "device", label: "设备", tools: ["lanshare", "adb", "ffbridge", "ytdlp"] },
    { id: "site", label: "站点", tools: ["about", "pdfcraft", "insectworld", "prehmuseum", "setup"] },
  ];
  ...
  const ABOUT_DESC = {
    ...
    healthread: "养生功法等文章离线阅读：正文与配图保存在本站，便于对照练习。",
    ...
    insectworld: "跳转 Insect World：63 种昆虫 3D 交互图鉴；新窗口打开，PWA 尽量用系统浏览器。",
    prehmuseum: "跳转史前动物博物馆（中文 3D 恐龙/古生物，适合亲子）；新窗口打开，PWA 尽量用系统浏览器。",
  ...
  const TOOL_META = {
    ...
    phlogo: { name: "P站风 Logo", aliases: ["ph", "logo", "logoly", "pornhub", "p站", "双色logo", "黄黑"] },
    nokiasms: { name: "诺基亚短信", aliases: ["nokia", "zzkia", "3310", "短信", "诺基亚", "怀旧"] },
    ...
    imgtrim: { name: "去色边", aliases: ["裁边", "去白边", "去黑边", "trim", "纯色边", "imgtrim"] },
    ...
    healthread: { name: "健康阅读", aliases: ["养生", "功法", "金刚功", "长寿功", "张至顺", "健康文章"] },
    ...
    sandspiel: { name: "落沙沙盒", aliases: ["sandspiel", "落沙", "粉末", "沙子", "powder", "sandbox", "沙盘", "元胞"] },
    ambient: {
      name: "环境音库",
    ...
    insectworld: { name: "昆虫世界", aliases: ["insect", "昆虫", "甲虫", "蝴蝶", "3d昆虫", "insect world"] },
    prehmuseum: { name: "史前博物馆", aliases: ["恐龙", "博物馆", "古生物", "leon", "史前动物"] },
    setup: {
      name: "安装本机工具",
    ...
    groupsInOrder().forEach((group) => {
      ...
      tools.forEach((id) => {
        ...
        if (showMobileSortHandles()) {
          ...
          row.appendChild(createNavSortHandle({ kind: "tool", id, wrap }));
          row.appendChild(a);
